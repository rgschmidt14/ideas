...
def run(playwright):
    ...
    # 5. Get the HTML content of the container and print it for debugging
    parents_container_html = page.locator("#focal-parents-container").inner_html()
    print("--- START: PARENTS CONTAINER HTML ---")
    print(parents_container_html)
    print("--- END: PARENTS CONTAINER HTML ---")

    # 6. Take a screenshot for visual confirmation
    page.screenshot(path="jules-scratch/verification/debug_screenshot_enhanced.png", full_page=True)
